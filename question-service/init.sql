...
-- Question 1
INSERT INTO questions (title, difficulty, description, constraints) VALUES 
...
INSERT INTO questions (id, title, difficulty, description, constraints) VALUES
...
-- Question 86: Count Palindromic Substrings with Constraints
INSERT INTO questions (id, title, difficulty, description, constraints) VALUES
(86, 'Count Palindromic Substrings with Constraints', 'hard', 'Given a string s and an integer k, count the number of palindromic substrings of length at least k. A substring is palindromic if it reads the same forward and backward.', '1 ≤ s.length ≤ 1000, 1 ≤ k ≤ s.length');
